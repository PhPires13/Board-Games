...
ifeq ($(OS),Windows_NT)
	$(RM) $(BIN_DIR)\Board_Games.exe $(BIN_DIR)\$(TESTS_DIR)\Board_Games_Tests.exe
	$(RM) $(OBJ_DIR)\*.o $(OBJ_DIR)\$(TESTS_DIR)\*.o
	$(RM) $(OBJ_DIR)\*.gcno $(OBJ_DIR)\$(TESTS_DIR)\*.gcno
else
	$(RM) $(BIN_DIR)/Board_Games $(TESTS_BIN_DIR)/Board_Games_Tests
	$(RM) $(OBJ_DIR)/*.o $(OBJ_DIR)/*/*.o
	$(RM) $(OBJ_DIR)/*.gcno $(OBJ_DIR)/*/*.gcno
endif

clean_coverage:
ifeq ($(OS),Windows_NT)
	$(RM) $(OBJ_DIR)\*.gcda $(OBJ_DIR)\$(TESTS_DIR)\*.gcda
else
